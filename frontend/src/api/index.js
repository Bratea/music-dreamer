...
export const songApi = {
  ...
  playCount: (songId) => request.post('/song/play/count', { songId }),
  collect: (songId) => request.post('/song/collect', { songId }),
  uncollect: (songId) => request.delete(`/song/collect/${songId}`),
  isCollected: (songId) => request.get(`/song/collect/${songId}`),
  publish: (data) => request.post('/singer/song/publish', data),
  mySongs: (status) => request.get('/singer/song/my', { params: { status } }),
  editSong: (data) => request.put('/singer/song/edit', data),
